...
class LocalDetector:
    ...
    def update_zones(
        ...
        self.customer_zone = validate(
            customer_zone,
            "customerZone",
        )

        self.staff_zone = validate(
            staff_zone,
            "staffZone",
        )
            ...
            while not (
                ...
                if (
                    ...
                    try:
                        ...
                        LOG.warning(
                            "Zone refresh failed: %s",
                            error,
                        )

                    last_zone_refresh_at = now
