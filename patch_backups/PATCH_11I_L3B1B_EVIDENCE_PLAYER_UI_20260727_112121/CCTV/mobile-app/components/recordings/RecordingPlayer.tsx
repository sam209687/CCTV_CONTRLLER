...
export default React.memo(
  RecordingPlayer,
  (previous, next) =>
    previous.recording.id === next.recording.id &&
    previous.recording.fileUrl === next.recording.fileUrl &&
    previous.recording.fileName === next.recording.fileName &&
    previous.recording.cameraId === next.recording.cameraId,
);
